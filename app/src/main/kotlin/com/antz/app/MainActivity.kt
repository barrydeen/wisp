...
import com.antz.app.repo.LocaleRepository
import com.antz.app.ui.component.LocalMediaSettings
import com.antz.app.ui.component.MediaSettings
import com.antz.app.ui.component.PipController
import com.antz.app.ui.theme.AntzTheme
...
class MainActivity : FragmentActivity() {
    ...
    override fun attachBaseContext(newBase: Context) {
        val prefs = newBase.getSharedPreferences("antz_settings", Context.MODE_PRIVATE)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            val prefs = remember { getSharedPreferences("antz_settings", Context.MODE_PRIVATE) }
            ...
            AntzTheme(isDarkTheme = isDarkTheme, accentColor = accentColor, isLargeText = isLargeText, themeName = themeName) {
