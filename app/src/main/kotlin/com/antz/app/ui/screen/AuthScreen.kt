...
import com.antz.app.nostr.RemoteSignerBridge
import com.antz.app.nostr.toHex
import com.antz.app.relay.TorStatus
...
fun AuthScreen(
    ...
    val signerLauncher = rememberLauncherForActivityResult(
        ...
        val pubkeyHex = if (result.startsWith("npub1")) {
            try { com.antz.app.nostr.Nip19.npubDecode(result).toHex() } catch (_: Exception) { return@rememberLauncherForActivityResult }
        } else {
            result
        }
