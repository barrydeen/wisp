...
import com.antz.app.nostr.Nip02
...
import com.antz.app.repo.Nip05Status
...
import com.antz.app.ui.component.ContentSegment
import com.antz.app.ui.component.FullScreenImageViewer
...
import com.antz.app.ui.component.parseContent
import com.antz.app.ui.component.parseImetaTags
import com.antz.app.ui.component.QrCodeDialog
import com.antz.app.ui.component.ProfilePicture
import com.antz.app.ui.component.RichContent
import com.antz.app.ui.component.ZapDialog
import com.antz.app.viewmodel.ProfileSortMode
...
fun UserProfileScreen(
    ...
    signer: com.antz.app.nostr.NostrSigner? = null,
    ...
    if (fullScreenMediaVideoUrl != null) {
        com.antz.app.ui.component.FullScreenVideoPlayer(
                    ...
                    if (pinnedEvents.isNotEmpty()) {
                        ...
                        items(items = pinnedEvents, key = { "pinned-${it.id}" }) { event ->
                            ...
                            val pinnedTranslationState = remember(translationVersion, event.id) {
                                translationRepo?.getState(event.id) ?: com.antz.app.repo.TranslationState()
                            }
                            ...
                            Row(
                                ...
                                for (event in row) {
                                    val firstMedia = remember(event.id) {
                                        val img = com.antz.app.nostr.Nip68.parseImetaEntries(event).firstOrNull()
                                        val vid = com.antz.app.nostr.Nip71.parseVideoMeta(event).firstOrNull()
                    ...
                    if (groupsLoading && groups.isEmpty()) {
                        ...
                        items(items = groups, key = { "${it.relayUrl}|${it.groupId}" }) { entry ->
                            Box(modifier = Modifier.padding(horizontal = 12.dp)) {
                                com.antz.app.ui.component.GroupCard(
