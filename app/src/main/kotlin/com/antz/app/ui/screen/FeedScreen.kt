package com.antz.app.ui.screen
...
import com.antz.app.nostr.FollowSet
import com.antz.app.nostr.Nip10
import com.antz.app.nostr.Nip69
import com.antz.app.nostr.NostrEvent
import com.antz.app.R
import com.antz.app.ui.component.NoteActions
import com.antz.app.ui.component.EmojiLibrarySheet
import com.antz.app.ui.component.GalleryCard
import com.antz.app.ui.component.isGalleryEvent
import com.antz.app.ui.component.PostCard
import com.antz.app.ui.component.ProfilePicture
import com.antz.app.ui.component.RelayIcon
import com.antz.app.ui.component.AntzDrawerContent
...
import com.antz.app.relay.BroadcastState
import com.antz.app.viewmodel.FeedContentFilter
import com.antz.app.viewmodel.FeedType
import com.antz.app.viewmodel.FeedViewModel
import com.antz.app.viewmodel.InitLoadingState
import com.antz.app.viewmodel.PowStatus
import com.antz.app.viewmodel.RelayFeedStatus
import com.antz.app.viewmodel.TrendingMetric
import com.antz.app.viewmodel.TrendingMode
import com.antz.app.viewmodel.TrendingTimeframe
import com.antz.app.viewmodel.buildTrendingRelayUrl
...
import com.antz.app.repo.AccountInfo
import com.antz.app.ui.component.FollowButton
import com.antz.app.viewmodel.TRENDING_USERS_RELAY_URL
...
fun FeedScreen(
    ...
    torStatus: com.antz.app.relay.TorStatus = com.antz.app.relay.TorStatus.DISABLED,
    ...
    onViewSetFeed: ((com.antz.app.nostr.InterestSet) -> Unit)? = null,
    ...
    fetchGroupPreview: (suspend (String, String) -> com.antz.app.repo.GroupPreview?)? = null,
    ...
    if (showOnlineSheet) {
        androidx.compose.material3.ModalBottomSheet(
            ...
            Column(
                ...
                val greenColor = AntzThemeColors.repostColor
                            ...
                            Surface(
                                ...
                                Row(
                                    ...
                                    Icon(
                                        ...
                                        tint = AntzThemeColors.repostColor
                                    )
                                    Spacer(Modifier.width(4.dp))
                                    Text(
                                        "${onlinePubkeys.size}",
                        ...
                        LazyColumn(
                            ...
                            if (liveNowStreams.isNotEmpty() && onLiveStreamClick != null) {
                                item(key = "live-now", contentType = "live-now") {
                                    com.antz.app.ui.component.LiveNowRow(
...
private fun FeedItem(
    ...
    nip05Version: Int = 0,
    followList: List<com.antz.app.nostr.Nip02.FollowEntry> = emptyList(),
...
private fun FeedArticleItem(
    ...
    Surface(
        ...
        Column {
            ...
            // Action bar
            com.antz.app.ui.component.ActionBar(
                onReply = onReply,
                onReact = onReact,
                userReactionEmojis = userEmojis,
                onRepost = onRepost,
...
private fun HashtagPickerDialog(
    sets: List<com.antz.app.nostr.InterestSet>,
    isLoading: Boolean = false,
    onSelectHashtag: (String) -> Unit,
    onViewSetFeed: (com.antz.app.nostr.InterestSet) -> Unit,
...
private fun TrendingFilterBar(
    ...
    val metricIcon = @Composable { m: TrendingMetric ->
        when (m) {
            ...
            TrendingMetric.ZAPS -> Icon(painter = androidx.compose.ui.res.painterResource(com.antz.app.R.drawable.ic_bolt), contentDescription = m.label, modifier = Modifier.size(14.dp))
        }
    }
...
private fun TrendingUsersContent(
    ...
    isLoading: Boolean,
    relayFeedStatus: RelayFeedStatus,
    contactRepo: com.antz.app.repo.ContactRepository,
    onProfileClick: (String) -> Unit,
...
private fun RelayFeedBar(
    ...
    val statusColor = when (relayFeedStatus) {
        is RelayFeedStatus.Streaming -> AntzThemeColors.repostColor
        is RelayFeedStatus.Connecting, is RelayFeedStatus.Subscribing -> AntzThemeColors.paidColor
        ...
        is RelayFeedStatus.Cooldown -> AntzThemeColors.zapColor
        else -> MaterialTheme.colorScheme.onSurfaceVariant
    }
