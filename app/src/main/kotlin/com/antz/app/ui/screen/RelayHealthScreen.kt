...
import com.antz.app.viewmodel.HealthFilter
import com.antz.app.viewmodel.HealthSortMode
import com.antz.app.viewmodel.RelayHealthSummary
import com.antz.app.viewmodel.RelayHealthViewModel
import com.antz.app.viewmodel.RelayType
        ...
        Row(
            ...
            Box {
                ...
                Surface(
                    ...
                    color = when {
                        ...
                        relay.cooldownRemaining > 0 -> AntzThemeColors.paidColor
                        relay.isConnected -> AntzThemeColors.repostColor
            ...
            Column(modifier = Modifier.weight(1f)) {
                ...
                if (!relay.isBad && relay.cooldownRemaining > 0) {
                    ...
                    Surface(
                        shape = RoundedCornerShape(4.dp),
                        color = AntzThemeColors.paidColor.copy(alpha = 0.15f)
                    ) {
                        Column(modifier = Modifier.padding(horizontal = 6.dp, vertical = 2.dp)) {
                            Text(
                                "Cooldown ${relay.cooldownRemaining}s",
                                style = MaterialTheme.typography.labelSmall,
                                color = AntzThemeColors.paidColor
                            )
                ...
                if (relay.sessionHistory.isNotEmpty()) {
                    ...
                    val healthColor = when {
                        ...
                        okSessions.toFloat() / total < 0.8f -> AntzThemeColors.paidColor
