...
fun ZapDialog(
    ...
    Dialog(
        ...
        Surface(
            ...
            color = AntzThemeColors.backgroundColor,
            tonalElevation = 8.dp
        ) {
            Box {
