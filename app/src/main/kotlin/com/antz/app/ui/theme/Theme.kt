...
val LocalAntzColors = androidx.compose.runtime.staticCompositionLocalOf {
    AntzColors(
...
object AntzThemeColors {
    val backgroundColor: Color @Composable get() = LocalAntzColors.current.backgroundColor
    val zapColor: Color @Composable get() = LocalAntzColors.current.zapColor
    val repostColor: Color @Composable get() = LocalAntzColors.current.repostColor
    val bookmarkColor: Color @Composable get() = LocalAntzColors.current.bookmarkColor
    val paidColor: Color @Composable get() = LocalAntzColors.current.paidColor
}

private val AntzTypography = Typography(
...
private val AntzTypographyLarge = Typography(
...
fun AntzTheme(
    ...
    MaterialTheme(
        ...
        typography = if (isLargeText) AntzTypographyLarge else AntzTypography,
        content = {
            CompositionLocalProvider(LocalAntzColors provides antzColors) {
                content()
            }
        }
    )
