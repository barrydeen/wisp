...
import com.antz.app.nostr.RelayInfo
    ...
    Column(
        ...
        Row(
            ...
            if (info?.paymentRequired == true) {
                StatusBadge("Paid", AntzThemeColors.paidColor)
            }
    ...
    Column(
        ...
        Row(
            ...
            StatCard(
                ...
                valueColor = if (stats.totalRateLimits > 0) AntzThemeColors.paidColor else null
            )
        }
