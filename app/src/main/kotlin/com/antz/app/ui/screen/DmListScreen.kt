...
private fun JoinGroupDialog(
    ...
    AlertDialog(
        ...
        confirmButton = {
            TextButton(
                onClick = {
                    val parsed = com.antz.app.nostr.Nip29.parseGroupIdentifier(inviteLink.trim())
                    if (parsed != null) {
...
private fun CreateGroupDialog(
    ...
    var relayUrl by remember { mutableStateOf(com.antz.app.nostr.Nip29.DEFAULT_GROUP_RELAYS.first()) }
