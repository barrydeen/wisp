...
class GroupPersistence {
    private val metaBox: Box<GroupMetaEntity> = AntzObjectBox.store.boxFor(GroupMetaEntity::class.java)
    private val msgBox: Box<GroupMessageEntity> = AntzObjectBox.store.boxFor(GroupMessageEntity::class.java)
