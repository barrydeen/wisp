...
import com.antz.app.ui.screen.BroadcastStatusBar
...
import com.antz.app.nostr.Nip10
import com.antz.app.nostr.Nip19
import com.antz.app.nostr.NostrUriData
import com.antz.app.nostr.NostrEvent
import com.antz.app.nostr.ProfileData
import com.antz.app.nostr.LocalSigner
import com.antz.app.nostr.RemoteSigner
import com.antz.app.nostr.SignerIntentBridge
import com.antz.app.nostr.SignResult
import com.antz.app.repo.SigningMode
import android.content.Context
import androidx.compose.runtime.rememberCoroutineScope
import androidx.compose.runtime.rememberUpdatedState
import com.antz.app.ui.component.HapticHelper
import com.antz.app.ui.component.NotifBlipSound
import com.antz.app.ui.component.BottomTab
import com.antz.app.ui.component.AntzBottomBar
import com.antz.app.ui.component.ZapDialog
import com.antz.app.ui.component.AuthApprovalDialog
import com.antz.app.ui.screen.BlossomServersScreen
import com.antz.app.ui.screen.AuthScreen
import com.antz.app.ui.screen.SplashScreen
import com.antz.app.ui.screen.ComposeScreen
import com.antz.app.ui.screen.ContactPickerScreen
import com.antz.app.ui.screen.DmConversationScreen
import com.antz.app.ui.screen.DmListScreen
import com.antz.app.ui.screen.DraftsScreen
import com.antz.app.ui.screen.FeedScreen
import com.antz.app.ui.screen.ProfileEditScreen
import com.antz.app.ui.screen.RelayScreen
import com.antz.app.ui.screen.ThreadScreen
import com.antz.app.ui.screen.NotificationsScreen
import com.antz.app.ui.screen.SafetyScreen
import com.antz.app.ui.screen.UserProfileScreen
import com.antz.app.ui.screen.ConsoleScreen
import com.antz.app.ui.screen.RelayHealthScreen
import com.antz.app.ui.screen.CustomEmojiScreen
import com.antz.app.ui.screen.SearchScreen
import com.antz.app.ui.screen.SocialGraphScreen
import com.antz.app.ui.screen.BookmarkSetScreen
import com.antz.app.ui.screen.ArticleScreen
import com.antz.app.ui.screen.BookmarksScreen
import com.antz.app.ui.screen.HashtagFeedScreen
import com.antz.app.ui.screen.KeysScreen
import com.antz.app.ui.screen.ListScreen
import com.antz.app.ui.screen.LiveStreamScreen
import com.antz.app.ui.screen.ExistingUserOnboardingScreen
import com.antz.app.ui.screen.LoadingScreen
import com.antz.app.ui.screen.ListsHubScreen
import com.antz.app.ui.screen.InterfaceScreen
import com.antz.app.ui.screen.PowSettingsScreen
import com.antz.app.ui.screen.OnboardingScreen
import com.antz.app.ui.component.AddNoteToListDialog
import com.antz.app.ui.component.CrashReportDialog
import androidx.media3.exoplayer.ExoPlayer
import com.antz.app.ui.component.FloatingVideoPlayer
import com.antz.app.ui.component.PipController
import com.antz.app.ui.component.FullScreenVideoPlayer
import com.antz.app.ui.screen.OnboardingSuggestionsScreen
import com.antz.app.ui.screen.RelayDetailScreen
import com.antz.app.ui.screen.WalletScreen
import com.antz.app.viewmodel.BlossomServersViewModel
import com.antz.app.viewmodel.ArticleViewModel
import com.antz.app.viewmodel.AuthViewModel
import com.antz.app.viewmodel.ComposeViewModel
import com.antz.app.viewmodel.DmConversationViewModel
import com.antz.app.viewmodel.DmListViewModel
import com.antz.app.viewmodel.FeedType
import com.antz.app.viewmodel.FeedViewModel
import com.antz.app.viewmodel.ProfileViewModel
import com.antz.app.viewmodel.RelayViewModel
import com.antz.app.viewmodel.ThreadViewModel
import com.antz.app.viewmodel.UserProfileViewModel
import com.antz.app.viewmodel.NotificationFilter
import com.antz.app.viewmodel.NotificationsViewModel
import com.antz.app.viewmodel.ConsoleViewModel
import com.antz.app.viewmodel.RelayHealthViewModel
import com.antz.app.viewmodel.DraftsViewModel
import com.antz.app.viewmodel.SearchViewModel
import com.antz.app.viewmodel.HashtagFeedViewModel
import com.antz.app.viewmodel.OnboardingViewModel
import com.antz.app.viewmodel.PowStatus
import com.antz.app.viewmodel.SplashViewModel
import com.antz.app.viewmodel.LiveStreamViewModel
import com.antz.app.viewmodel.WalletViewModel
...
fun AntzNavHost(
    ...
    val groupListViewModel: com.antz.app.viewmodel.GroupListViewModel = viewModel()
    ...
    // Tor state
    val torPrefs = remember { context.getSharedPreferences("antz_settings", android.content.Context.MODE_PRIVATE) }
    val torStatus by com.antz.app.relay.TorManager.status.collectAsState()
    val isTorEnabled = torStatus != com.antz.app.relay.TorStatus.DISABLED
    ...
    LaunchedEffect(Unit) {
        if (torPrefs.getBoolean("tor_enabled", false)) {
            com.antz.app.relay.TorManager.start()
        }
    }
    ...
    LaunchedEffect(torStatus) {
        ...
        if (torStatus == com.antz.app.relay.TorStatus.CONNECTED ||
            torStatus == com.antz.app.relay.TorStatus.DISABLED) {
    ...
    val onToggleTor: (Boolean) -> Unit = { enabled ->
        ...
        torScope.launch {
            if (enabled) {
                ...
                com.antz.app.relay.TorManager.stop()
            }
        }
    }
    ...
    val socialGraphComputing = currentRoute == Routes.SOCIAL_GRAPH && (
        socialGraphDiscoveryState is com.antz.app.repo.DiscoveryState.FetchingFollowLists ||
        socialGraphDiscoveryState is com.antz.app.repo.DiscoveryState.BuildingGraph ||
        socialGraphDiscoveryState is com.antz.app.repo.DiscoveryState.ComputingNetwork ||
        socialGraphDiscoveryState is com.antz.app.repo.DiscoveryState.Filtering ||
        socialGraphDiscoveryState is com.antz.app.repo.DiscoveryState.FetchingRelayLists)
    ...
    val notifPrefs = remember { context.getSharedPreferences("antz_settings", Context.MODE_PRIVATE) }
    ...
    NavHost(
        ...
        composable(Routes.SEARCH) {
            ...
            SearchScreen(
                ...
                isEmojiSetAdded = { pubkey, dTag ->
                    val ref = com.antz.app.nostr.Nip30.buildSetReference(pubkey, dTag)
                    feedViewModel.customEmojiRepo.userEmojiList.value?.setReferences?.contains(ref) ?: false
                }
            )
        }
        ...
        composable(
            ...
            DmConversationScreen(
                ...
                noteActions = remember {
                    com.antz.app.ui.component.NoteActions(
                        onAddEmojiSet = { pk, dTag -> feedViewModel.addSetToEmojiList(pk, dTag) },
                        onRemoveEmojiSet = { pk, dTag -> feedViewModel.removeSetFromEmojiList(pk, dTag) },
                        isEmojiSetAdded = { pk, dTag ->
                            val ref = com.antz.app.nostr.Nip30.buildSetReference(pk, dTag)
        ...
        composable(
            ...
            val groupRoomViewModel: com.antz.app.viewmodel.GroupRoomViewModel = viewModel()
            ...
            var groupRoomZapTarget by remember { mutableStateOf<com.antz.app.nostr.NostrEvent?>(null) }
            ...
            com.antz.app.ui.screen.GroupRoomScreen(
                ...
                onZap = { msgId, senderPubkey ->
                    groupRoomZapTarget = com.antz.app.nostr.NostrEvent(
                        id = msgId,
                        pubkey = senderPubkey,
                        created_at = 0L,
                        kind = com.antz.app.nostr.Nip29.KIND_CHAT_MESSAGE,
                    ...
                    feedViewModel.relayPool.sendToRelayOrEphemeral(
                        relayUrl,
                        com.antz.app.nostr.ClientMessage.req(
                            subscriptionId = "zap-rcpt-grp-${msgId.take(12)}",
                            filter = com.antz.app.nostr.Filter(kinds = listOf(9735), eTags = listOf(msgId))
                        ),
                        skipBadCheck = true
                    )
                },
        ...
        composable(
            ...
            com.antz.app.ui.screen.GroupDetailScreen(
                groupId = groupId,
                relayUrl = relayUrl,
                groupListViewModel = groupListViewModel,
                eventRepo = feedViewModel.eventRepo,
        ...
        composable(
            ...
            var articleZapTarget by remember { mutableStateOf<com.antz.app.nostr.NostrEvent?>(null) }
        ...
        composable(
            ...
            val streamActivityEventId = remember(hostPubkey, dTag) {
                feedViewModel.eventRepo.findAddressableEvent(
                    com.antz.app.nostr.Nip53.KIND_LIVE_ACTIVITY, hostPubkey, dTag
                )?.id
            }
            LiveStreamScreen(
                ...
                onZapStream = {
                    ...
                    if (activityEvent != null) {
                        ...
                        liveZapATag = com.antz.app.nostr.Nip53.aTagValue(hostPubkey, dTag)
                    }
                },
        ...
        composable(Routes.INTERFACE_SETTINGS) {
            ...
            val interfacePrefs = remember { com.antz.app.repo.InterfacePreferences(context) }
            InterfaceScreen(
                application = app,
        ...
        composable(Routes.NOTIFICATIONS) {
            ...
            val notifInterfacePrefs = remember { com.antz.app.repo.InterfacePreferences(context) }
            ...
            NotificationsScreen(
                ...
                onSendReply = { replyToEvent, content ->
                    ...
                    notifReplyScope.launch {
                        ...
                        val tags = com.antz.app.nostr.Nip10.buildReplyTags(replyToEvent, hint) +
                            com.antz.app.nostr.Nip30.buildEmojiTagsForContent(content, notifResolvedEmojis) +
                            if (notifInterfacePrefs.isClientTagEnabled()) listOf(listOf("client", "Antz")) else emptyList()
                        ...
                        if (feedViewModel.powPrefs.isNotePowEnabled()) {
                            feedViewModel.powManager.submitNote(
                                ...
                                onPublished = {
                                    ...
                                    val rootId = com.antz.app.nostr.Nip10.getRootId(replyToEvent)
                            ...
                            val msg = com.antz.app.nostr.ClientMessage.event(event)
