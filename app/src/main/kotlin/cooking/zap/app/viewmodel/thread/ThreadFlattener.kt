package cooking.zap.app.viewmodel.thread

import cooking.zap.app.nostr.NostrEvent

/**
 * Pure, side-effect-free flattener that turns a parent→children reply tree into a
 * [ThreadItem] list for the UI. Shared by [cooking.zap.app.viewmodel.ThreadViewModel] and
 * [cooking.zap.app.viewmodel.ArticleViewModel] so the two paths can't drift.
 *
 ...
 *    affordance that the user expands *inline* (Threads-style, scroll position preserved) rather
 *    than navigating away. Putting the anchor in [expandedIds] overrides the cap for that branch.
