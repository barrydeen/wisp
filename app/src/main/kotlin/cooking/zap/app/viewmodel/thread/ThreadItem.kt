...
sealed interface ThreadItem {
    ...
    /** A folded subtree under [anchor] that the user can expand inline (Threads-style), keeping
     *  scroll position anchored on the note above. [hiddenCount] is the subtree size. */
