...
class NotificationRepository(
    ...
    var spamClassifier: cooking.zap.app.ml.NSpamClassifier? = null
    var spamAuthorCache: SpamAuthorCache? = null
    var safetyPrefs: SafetyPreferences? = null
    var contactRepo: ContactRepository? = null
    var extendedNetworkRepo: cooking.zap.app.repo.ExtendedNetworkRepository? = null
                ...
                if (classifier != null && cache != null && repo != null) {
                    ...
                    if (notes.isNotEmpty()) {
                        val inputs = notes.map { e ->
                            cooking.zap.app.ml.NoteInput(e.content, e.tags, e.created_at)
                        }
